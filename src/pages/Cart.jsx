...
import { decQuantity, emptyCart, incQuantity, removeItem } from '../REDUX/Slices/cartSlice'
            ...
            <div className="col-lg-8">
                <table className='table'>
                    ...
                    { 
                      ...
                      <td><img style={{width:'50px',height:'40px'}} src={product.thumpnail} alt="" /></td>
                      <td>
                      ...
                      <td>
                      <button className='btn' onClick={()=>dispatch(removeItem(product.id))}><i className="fa-solid fa-trash text-danger"></i></button>
                      </td>
                      </tr>
                      ))
