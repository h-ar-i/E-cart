            ...
            <div className="container" style={{ marginTop: '150px' }}>
              ...
              loading?<div className='mt-5 text-center fw-bolder'>  <Spinner animation="border" variant="info" /> Loading....</div>:
               ...
               <Row>
                   ...
                   <Col className='mb-5 container-fluid ms-1' sm={12} md={6} lg={4} xl={3}>
                        <Card className='shadow rounded  ' style={{ width: '18rem' }}>
                            ...
                            <Card.Body>
                                ...
                                <div className='text-center'><Link to={`/view/${product?.id}`}
                                 variant="Primary" style={{textDecoration:'none'}}>View More</Link>
                                </div>       
                                </Card.Body>
                        </Card>
              ...
              <div className="d-flex justify-content-center align-items-center mt-5 mb-5">
                <span onClick={navigateToPrev} style={{cursor:'pointer'}}><i className='fa-solid fa-angles-left me-5'></i></span>
                <span className='fw-bolder'>{currentPage} of {totalPages} </span>
                <span onClick={navigateToNext} style={{cursor:'pointer'}}><i className='fa-solid fa-angles-right ms-5'></i></span>
